...
class ToolParameters(RootModel):
    """Model for tool parameters in a function call"""
    root: Dict[str, Any] = Field(default_factory=dict, description="Dictionary of parameter name to parameter value")
...
class TripOutputParser(BaseModel):
